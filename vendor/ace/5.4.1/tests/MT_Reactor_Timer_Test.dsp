...
!IF  "$(CFG)" == "MT_Reactor_Timer_Test - Win32 Release"

# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
# PROP Output_Dir "Release"
# PROP Intermediate_Dir "Release\MT_Reactor_Timer_Test"
# PROP Target_Dir ""
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Output.lib ACE.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:"Release\MT_Reactor_Timer_Test.pdb"  /machine:I386 /out:"Release\MT_Reactor_Timer_Test.exe"
...
# PROP Output_Dir "."
# PROP Intermediate_Dir "Debug\MT_Reactor_Timer_Test"
# PROP Target_Dir ""
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Outputd.lib ACEd.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:".\MT_Reactor_Timer_Test.pdb" /debug /machine:I386 /out:".\MT_Reactor_Timer_Test.exe"
