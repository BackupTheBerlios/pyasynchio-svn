...
!MESSAGE
!MESSAGE NMAKE /f "SV_Shared_Memory_Test.mak" CFG="SV_Shared_Memory_Test - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "SV_Shared_Memory_Test - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Output.lib ACE.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:"Release\SV_Shared_Memory_Test.pdb"  /machine:I386 /out:"Release\SV_Shared_Memory_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Outputd.lib ACEd.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:".\SV_Shared_Memory_Test.pdb" /debug /machine:I386 /out:".\SV_Shared_Memory_Test.exe"
