...
!MESSAGE
!MESSAGE NMAKE /f "MT_Reference_Counted_Notify_Test.mak" CFG="MT_Reference_Counted_Notify_Test - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "MT_Reference_Counted_Notify_Test - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Output.lib ACE.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:"Release\MT_Reference_Counted_Notify_Test.pdb"  /machine:I386 /out:"Release\MT_Reference_Counted_Notify_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Outputd.lib ACEd.lib /libpath:"..\lib" /nologo /version:5.4 /subsystem:console /pdb:".\MT_Reference_Counted_Notify_Test.pdb" /debug /machine:I386 /out:".\MT_Reference_Counted_Notify_Test.exe"
