...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEXML_Parser.lib ACEXML.lib ACE.lib /libpath:"..\..\lib" /nologo /version:5.403 /subsystem:console /pdb:"Release\ContentHandler_Test.pdb"  /machine:I386 /out:"Release\ContentHandler_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEXML_Parserd.lib ACEXMLd.lib ACEd.lib /libpath:"..\..\lib" /nologo /version:5.403 /subsystem:console /pdb:".\ContentHandler_Test.pdb" /debug /machine:I386 /out:".\ContentHandler_Test.exe"
