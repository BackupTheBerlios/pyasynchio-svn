...
!MESSAGE
!MESSAGE NMAKE /f "ACEXML_Parser.mak" CFG="ACEXML_Parser - Win32 Debug"
!MESSAGE
...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEXML.lib ACE.lib /libpath:"..\..\..\lib" /nologo /version:5.403 /subsystem:windows /pdb:"..\..\..\lib\ACEXML_Parser.pdb" /dll  /machine:I386 /out:"..\..\..\lib\ACEXML_Parser.dll"
...
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD CPP /nologo /Ob0 /W3 /Gm /GX /Zi /MDd /GR /Gy /I "..\..\.." /D _DEBUG /D WIN32 /D _WINDOWS /D ACEXML_PARSER_BUILD_DLL /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD BSC32 /nologo /o"..\..\..\lib\ACEXML_Parser.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEXMLd.lib ACEd.lib /libpath:"..\..\..\lib" /nologo /version:5.403 /subsystem:windows /pdb:"..\..\..\lib\ACEXML_Parserd.pdb" /dll /debug /machine:I386 /out:"..\..\..\lib\ACEXML_Parserd.dll"
